...
<!-- Mirrored from wpthemebooster.com/demo/themeforest/html/immigway/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Apr 2025 14:30:14 GMT -->
<head>
        <!-- Meta Tags -->
        <meta charset="utf-8">
    ...
    <body class="theme-style2">
        ...
        <div class="aside_info_wrapper">
			...
			<div class="aside_info_inner">
                ...
                <p>WWV(World Wide Visa) a full-service consultation firm with record of winning many successful campaigns. For a growing business firm we provide market research & competitor analysis before a product launch in market.</p>
                
                <div class="aside_info_inner_box">
                    <h5>Contact Info</h5>
                    <p><a href="mailto:support@immigway.com">support@immigway.com</a></p>
                    <p><a href="tel:+91 75388 80425">+91 75388 80425</a></p>
                    <p>World Wide Visa · 1st floor, 6, 2nd St, Jothi Nagar, Ramanuja Nagar, Coimbatore, Tamil Nadu 641015, India</p>
                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="wptb-heading more-padding">
                                                <div class="wptb-item--inner text-center">
                                                    <h6 class="wptb-item--subtitle"> WELCOME TO WORLD WIDE VISA </h6>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-7 col-lg-6 col-md-10 col-sm-12">
                                            <div class="wptb-heading">
                                                <div class="wptb-item--inner">
                                                    <h6 class="wptb-item--subtitle"> WELCOME TO WORLD WIDE VISA</h6>
                                                    <h1 class="wptb-item--title"> We Help You to Explore the worlds with <span class="active">Immigway</span></h1>
                                                    <p class="wptb-item--description">We provide a complete immigration & visa services for America,
                                                        Canada & Australia for travel & education</p>
                                                </div>
                                            </div>
                                ...
                                <div class="wptb-heading">
                                    <div class="wptb-item--inner">
                                        ...
                                        <p class="wptb-item--description">
                                            Established in 2018, our company was founded with a vision to become a comprehensive travel solution for all. What started as a shared dream between passionate individuals has now grown into a trusted name in the travel industry.
                                        </p>
                                    </div>
                                </div>
                                                ...
                                                <div class="wptb-piechart wow fadeInLeft" data-wow-delay="600ms">
                                                    <div class="wrap-meta">
                                                        <div class="wrap-meta--inner">
                                                            <span class="wptb--counter-number"> <span class="wptb--counter-value odometer" data-count="7"></span> </span> <span class="wptb--rating-label"> Years of Experience </span> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="wptb-counter1 style1 wow skewIn">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--value"><span class="odometer" data-count="4"></span><span class="suffix">k +</span></div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="wptb-counter1 style1 wow skewIn">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--value"><span class="odometer" data-count="22"></span><span class="suffix">k +</span></div>
                                        <div class="wptb-item--text">Completed Operations</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="wptb-counter1 style1 no-border wow skewIn">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--value"><span class="odometer" data-count="45"></span><span class="suffix">k +</span></div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="wptb-country-grid">
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        <div class="wptb-item--icon"><img src="assets/img/country/usa.png" alt=""></div>
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">Visa Services</p>
                                            <h5 class="wptb-item--title">USA</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Usually approves multiple entry visas valid for 10 years (B1, B2)</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text"> 6 months maximum duration of stay</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Acceptable for business and tourism purposes (B1, B2)</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa free entry to 40 countries including Europe</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Ages below 14 and above 80 are exempted from the interview</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">5 to 6 days processing time (from the day of interview)</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="wptb-country-grid">
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa for Single/multiple entries</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa validity up to 10 years and a minimum of 6 months</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Free entry to the island of Ireland and premises</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Six-months maximum duration of stay</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Six-months maximum duration of stay</div>
                                    ...
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Ideal for business, tourism, visiting family and friends, transit through the UK, etc</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing takes 20 to 25 working days</div>
                                    </div>
                                </div>
                            ...
                            <div class="wptb-country-grid">
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        ...
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">Visa Services</p>
                                            <h5 class="wptb-item--title">Canadian Visa</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa Type: Multiple Entry Visa</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Validity: Up to 10 years (or passport expiry, whichever is earlier)</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Minimum Stay: 6 months per visit</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Maximum Stay Duration: 6 months per entry</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing Time: Approximately 25 to 30 working days</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Maximum Stay Duration: 6 months per entry</div>
                                    ...
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Requirements: Children under 14 years are exempt from biometrics</div>
                                    </div>
                                    <!-- <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Requirements: Children under 14 years are exempt from biometrics</div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="wptb-country-grid">
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        <div class="wptb-item--icon"><img src="assets/img/country/schengen.png" alt=""></div>
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">Visa Services</p>
                                            <h5 class="wptb-item--title">Schengen Visa</h5>
                                        </div>
                                    </div>
                                </div>                                
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa Type: Single or Multiple Entry</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Validity: Up to 3 months per entry</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing Time: Approximately 10 to 15 working days</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Requirements: Recent photograph as per specifications</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Requirements: Last 3 months bank statement</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Special Note: Visa fee is waived for applicants under the age of 6</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Valid for entry into 29 Schengen countries</div>
                                    </div>
                                </div>
                            ...
                            <div class="wptb-country-grid">
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        ...
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">Visa Services</p>
                                            <h5 class="wptb-item--title">South Korean Visa</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa Types: Single, Double, or Multiple Entry</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing Time: Approximately 10 to 15 working days</div>
                                    ...
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Require alid passport with at least 6 months validity</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa fee is waived for applicants under the age of 6</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Children below 14 years are exempt from biometrics</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Applicants must apply for a visa prior to traveling; visa-on-arrival is not available for Indian citizens</div>
                                    </div>
                                </div>
                            ...
                            <div class="wptb-country-grid">
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        ...
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">Visa Services</p>
                                            <h5 class="wptb-item--title">Japan Visa</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa Types: Single Entry, Double Entry, Multiple Entry​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing Time: Minimum 5 working days​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Application Method: Submit through VFS Global; no prior appointment needed​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Require valid passport with at least 6 months validity​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Completed and signed visa application form​​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Recent passport-sized photograph (45mm x 35mm) with 70–80% face visibility​</div>
                                    </div>
                                </div>
                            ...
                            <div class="wptb-country-grid">
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        ...
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">Visa Services</p>
                                            <h5 class="wptb-item--title">Australian Visa</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa Types: Single or Multiple Entry​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Visa Validity: Up to 12 months​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Passport Requirement: Valid for at least 6 months from the date of travel​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Financial Proof: Attested bank statements for the last 6 months​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Photograph Specification: Recent photo (35mm x 45mm) with 80% face coverage​​</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Permitted to attend short-term courses or training programs up to 3 months​​</div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 border-1 border-bottom border-end ps-md-0 pt-md-0 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        ...
                                        <p class="wptb-item--description mb-0">Fostering worldwide interconnectedness through seamless communication, cultural exchange, and collaborative innovation.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 border-1 border-bottom border-end pt-md-0 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        ...
                                        <p class="wptb-item--description mb-0">Our experienced team ensures accurate and efficient visa applications, providing end-to-end support for a smooth approval process.​</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 border-1 border-bottom pt-md-0 pe-md-0 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        ...
                                        <p class="wptb-item--description mb-0">Experience swift and efficient visa processing with our streamlined procedures, ensuring timely approvals and minimal delays.​</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 border-1 border-end ps-md-0 pb-md-0 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        ...
                                        <p class="wptb-item--description mb-0">Our dedicated panel of seasoned professionals offers personalized guidance, ensuring your visa application process is smooth and successful.​</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 border-1 border-end pb-md-0 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        ...
                                        <h3 class="wptb-item--title">Professional Advisory Team</h3>
                                        <p class="wptb-item--description mb-0">A dedicated group of seasoned professionals providing personalized guidance to ensure your visa application process is smooth and successful.​</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 pe-md-0 pb-md-0 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        ...
                                        <h3 class="wptb-item--title">Specialist Assistance Group</h3>
                                        <p class="wptb-item--description mb-0">Our team of specialists offers tailored support, ensuring accuracy and efficiency throughout your visa application journey.​</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="wptb-faq--inner">
                        <div class="wptb-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="wptb-item--description">Empowering individuals to achieve their global aspirations through expert guidance in education and migration services.​.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="wptb-accordion wptb-accordion1 wow fadeInUp">
                                    <div class="wptb--item active">
                                        <h6 class="wptb-item-title"><span>Q1. What are the general prerequisites for immigration ?</span> <i class="bi bi-chevron-down"></i></h6>
                                        <div class="wptb-item--content">
                                            Prerequisites vary by country and visa type but typically include a valid passport, financial stability, health and character certificates, and, for certain categories, proof of employment or admission to an educational institution.​
                                        </div>
                                    </div>
            
                                    <div class="wptb--item">
                                        <h6 class="wptb-item-title"><span>Q2. What is the contact address of World Wide Visa ?</span> <i class="bi bi-chevron-down"></i></h6>
                                        <div class="wptb-item--content">
                                            Our office is located at World Wide Visa · 1st floor, 6, 2nd St, Jothi Nagar, Ramanuja Nagar, Coimbatore, Tamil Nadu 641015, India. You can reach us via phone at +91 75388 80425 or email at worldwidevisa.wwv@gmail.com.​
                                        </div>
                                    </div>
            
                                    <div class="wptb--item">
                                        <h6 class="wptb-item-title"><span>Q3. What IELTS score is required for Canada?</span> <i class="bi bi-chevron-down"></i></h6>
                                        <div class="wptb-item--content">
                                            For Canada, the required IELTS score depends on the visa category. For example, the Federal Skilled Worker Program typically requires a minimum of CLB 7, which corresponds to an IELTS score of 6.0 in each band.​
                                        </div>
                                    </div>
            
                                    <div class="wptb--item">
                                        <h6 class="wptb-item-title"><span>Q4. How much time is needed for visa renewal?</span> <i class="bi bi-chevron-down"></i></h6>
                                        <div class="wptb-item--content">
                                            Visa renewal processing times vary by country and visa type. Generally, it can take anywhere from a few days to several weeks. It's advisable to apply well in advance of your visa's expiration date.​
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="wptb-form--bottom">
                                            <div class="wptb-heading">
                                                <div class="wptb-item--inner">
                                                    ...
                                                    <h1 class="wptb-item--title"> <span>+91 75388 80425</span></h1>
                ...
                <div class="container">
                    ...
                    <div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    <h6 class="wptb-item--category"><a href="#">USA</a></h6>
                                    <h4 class="wptb-item--title"><a href="#">Visa</a></h4>
                                    <p class="wptb-item--description">Our team of qualified professionals offers end-to-end visa assistance, ensuring a smooth and efficient application process for various countries.</p>
                                </div>
                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/country/flat_usa.png" alt="img"></a>
                                </div>
                            </div>
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Up to 10 years with multiple entries.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Maximum of 6 months per visit.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">For business (B1) or tourism (B2).</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">14 - 79 may qualify for an interview waiver.</div>
                                    </div>
                                </div>
                    ...
                    <div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    <h6 class="wptb-item--category"><a href="#">UK</a></h6>
                                    <h4 class="wptb-item--title"><a href="#">Visa</a></h4>
                                    <p class="wptb-item--description">Our team of qualified professionals offers end-to-end visa assistance, ensuring a smooth and efficient application process for various countries.</p>
                                </div>
                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/country/flat_uk.png" alt="img"></a>
                                </div>
                            </div>
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    ...
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">For tourism, business, or transit.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing time: 3 weeks.</div>
                                    </div>
                                </div>
                                <div class="wptb-item--price">
                                    <span class="wptb-service-price">Rs.11,499</span> <span class="wptb-service-price-for">Per Apply</span>
                    ...
                    <div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    <h6 class="wptb-item--category"><a href="#">Canada</a></h6>
                                    <h4 class="wptb-item--title"><a href="#">Visa</a></h4>
                                    <p class="wptb-item--description">Our team of qualified professionals offers end-to-end visa assistance, ensuring a smooth and efficient application process for various countries.</p>
                                </div>
                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/country/flat_canada.png" alt="img"></a>
                                </div>
                            </div>
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    ...
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing time: 25–30 working days.</div>
                                    </div>
                                </div>
                                <div class="wptb-item--price">
                                    <span class="wptb-service-price">Rs.11,499</span> <span class="wptb-service-price-for">Per Apply</span>
                    ...
                    <div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    <h6 class="wptb-item--category"><a href="#">Australia</a></h6>
                                    <h4 class="wptb-item--title"><a href="#">Visa</a></h4>
                                    <p class="wptb-item--description">Our team of qualified professionals offers end-to-end visa assistance, ensuring a smooth and efficient application process for various countries.</p>
                                </div>
                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/country/flat_australia.png" alt="img"></a>
                                </div>
                            </div>
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Multiple entries up to 12 months validity.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Stay up to 3 months per visit.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Suitable for tourism or business purposes.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing time: 20–45 days.</div>
                                    </div>
                                </div>
                                <div class="wptb-item--price">
                                    <span class="wptb-service-price">Rs.11,499</span> <span class="wptb-service-price-for">Per Apply</span>
                    ...
                    <div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    <h6 class="wptb-item--category"><a href="#">Schengen</a></h6>
                                    <h4 class="wptb-item--title"><a href="#">Visa</a></h4>
                                    <p class="wptb-item--description">Our team of qualified professionals offers end-to-end visa assistance, ensuring a smooth and efficient application process for various countries.</p>
                                </div>
                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/country/flat_schengen.png" alt="img"></a>
                                </div>
                            </div>
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Valid for up to 90 days within 180 days.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Applicable for 26 European countries.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Suitable for tourism, business, or family visits.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing time: 15–20 working days.</div>
                                    </div>
                                </div>
                                <div class="wptb-item--price">
                                    <span class="wptb-service-price">Rs.11,499</span> <span class="wptb-service-price-for">Per Apply</span>
                    ...
                    <div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    <h6 class="wptb-item--category"><a href="#">South Korea</a></h6>
                                    <h4 class="wptb-item--title"><a href="#">Visa</a></h4>
                                    <p class="wptb-item--description">Our team of qualified professionals offers end-to-end visa assistance, ensuring a smooth and efficient application process for various countries.</p>
                                </div>
                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/country/flat_south_korea.png" alt="img"></a>
                                </div>
                            </div>
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Single or multiple entry options available.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Stay up to 90 days per visit.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Suitable for tourism, business, or family visits.</div>
                                    ...
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing time: 10–15 working days.</div>
                                    </div>
                                </div>
                                <div class="wptb-item--price">
                                    <span class="wptb-service-price">Rs.11,499</span> <span class="wptb-service-price-for">Per Apply</span>
                    ...
                    <div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    <h6 class="wptb-item--category"><a href="#">Japan</a></h6>
                                    <h4 class="wptb-item--title"><a href="#">Visa</a></h4>
                                    <p class="wptb-item--description">Our team of qualified professionals offers end-to-end visa assistance, ensuring a smooth and efficient application process for various countries.</p>
                                </div>
                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/country/flat_japan.png" alt="img"></a>
                                </div>
                            </div>
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Single-entry visa valid for 90 days.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Stay up to 90 days per visit.</div>
                                    ...
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Applicable for tourism, business, or family visits.</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Processing time: Minimum 5 working days.</div>
