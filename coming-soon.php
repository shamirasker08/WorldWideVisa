    ...
    <body class="theme-style2">
        ...
        <div class="aside_info_wrapper">
			...
			<div class="aside_info_inner">
                ...
                <p>Immigwayis a full-service consultation firm with record of winning many successful campaigns. For a growing business firm we provide market research & competitor analysis before a product launch in market.</p>
        ...
        <main class="wrapper">
            ...
            <!-- Coming Soon -->
            <section class="wptb-credential bg-image" style="background-image: url('assets/img/background/bg-9.jpg');">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="wptb-item--inner">
                                <div class="wptb-heading">
                                    <div class="wptb-item--inner text-center">
                                        ...
                                        <h1 class="wptb-item--title"> <span>Coming Soon!</span></h1>
                                    </div>
                                </div>
                                ...
                                <div class="text-center mr-top-30">
                                    <a href="index.php" class="btn">
                                        <span class="btn-wrap">
                                            ...
                                            <span class="text-second"><i class="bi bi-arrow-left"></i></span>
                                        </span>
                                    </a>
                                </div>
